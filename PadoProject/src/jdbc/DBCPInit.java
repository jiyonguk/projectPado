...
public class DBCPInit extends HttpServlet {
	...
	private void initConnectionPool() {
		...
		try {
			...
			String jdbcDriver =	"jdbc:mysql://admin.cug9x68k04ec.ap-northeast-2.rds.amazonaws.com/project?autoReconnect=true&useUnicode=true&characterEncoding=utf-8&serverTimezone=UTC";
			String username = "bit";
			String pw = "bit";
